...
|------------------|---------|--------------|-------------------------------------------------------------------------------------|
| items            | array   | []         | The array of items for the accordion. Each item should have a 'title' and 'content' property. |
| defaultOpenIndex | number  | null       | The index of the item that should be open by default.                               |
| multiOpen        | boolean | false      | When enabled, multiple accordion sections can be open at the same time.             |
| theme            | string  | greenTheme | The theme to apply to the accordion.                                                 |
`}
</Markdown>
